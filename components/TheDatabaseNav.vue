    ...
    <div class="mb-12">
        <div class="flex items-center w-full">
            <label for="toogleA" class="flex items-center cursor-pointer">
                <div class="mr-3 text-gray-700 font-medium transition duration-200 ease-in-out" :class="[value ? 'opacity-25' : '']">
                    Edit Content
                </div>
                <div class="relative">                
                    <input id="toogleA" type="checkbox" class="hidden" v-bind:checked="value" v-on:change="$emit('input', !value)" />
                ...
                <div class="ml-3 text-gray-700 font-medium transition duration-200 ease-in-out" :class="[!value ? 'opacity-25' : '']">
                    Edit Schema
                </div>
            </label>            
